...
namespace cslt.session05
{
    internal class ex05
    {
        static void bai1_CheckTriangleType()
        {
        ...
        static void bai2_TongVaTrungBinh10so()
        {
            double sum = 0;
        ...
        static void bai5_InCacMauHinhSo()
        {
            int n = int.Parse(Console.ReadLine());
            for (int i = 1; i <= n; i++)
            {
